"""
I guess this requires that you use the azure project client instead of the openai client,
but I can't get it working:
agent_framework.exceptions.ServiceResponseException: Failed to resolve model info for: gpt-5-chat
"""
...
async def main() -> None:
    ...
    async with (
        ...
        print(response.raw_representation)
