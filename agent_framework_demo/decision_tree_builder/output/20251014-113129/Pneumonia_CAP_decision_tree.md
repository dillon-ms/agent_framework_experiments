...
flowchart TD
    ...
    N2["Pathogen-specific therapy based on available results<br/><br/>Condition: blood_culture_result_available OR urine_antigen_result_available"]
    N1 --> N2
    N3["S. pneumoniae PCN susceptible<br/><br/>Condition: s_pneumoniae_pcn_susceptible<br/><br/>Decision: Penicillin G IV Q6H OR Amoxicillin PO Q8H; if non-severe PCN allergy: Cefdinir PO Q12H; if severe PCN allergy: Azithromycin PO daily x3 days OR Azithromycin 500 mg once then 250 mg daily x4 days OR Moxifloxacin IV/PO daily"]
    N2 --> N3
    N4["S. pneumoniae intermediate PCN or urine antigen positive<br/><br/>Condition: s_pneumoniae_pcn_intermediate_or_urine_antigen_positive<br/><br/>Decision: Penicillin G IV Q6H OR Amoxicillin 1 g PO Q8H; same allergy alternatives as above"]
    N2 --> N4
    N5["S. pneumoniae PCN resistant, cephalosporin susceptible<br/><br/>Condition: s_pneumoniae_pcn_resistant_cephalosporin_susceptible<br/><br/>Decision: Ceftriaxone IV Q24H OR Cefdinir PO Q12H; PCN allergy: Moxifloxacin IV/PO Q24H"]
    N2 --> N5
    N6["H. influenzae Ampicillin susceptible<br/><br/>Condition: h_influenzae_ampicillin_susceptible<br/><br/>Decision: Ampicillin IV Q6H OR Amoxicillin PO Q8H; PCN allergy options: Azithromycin PO x3 days OR PO taper, Cefdinir PO Q12H, Doxycycline PO Q12H if susceptible, Moxifloxacin IV/PO daily if resistant"]
    N2 --> N6
    N7["H. influenzae Ampicillin resistant<br/><br/>Condition: h_influenzae_ampicillin_resistant<br/><br/>Decision: Ampicillin/sulbactam IV Q6H OR Amoxicillin/clavulanate PO Q12H; PCN allergy options same as above"]
    N2 --> N7
    N8["Legionella pneumophila<br/><br/>Condition: l_pneumophila<br/><br/>Decision: Azithromycin IV/PO Q24H OR Moxifloxacin IV/PO Q24H; PCN allergy: Azithromycin IV/PO Q24H x 7-10 days OR Moxifloxacin IV/PO Q24H x 10-14 days"]
    N2 --> N8
    N9["Culture and urine antigen negative<br/><br/>Condition: culture_and_urine_antigen_negative<br/><br/>Decision: Cefdinir PO BID OR Amoxicillin/clavulanate XR PO Q12H; PCN allergy: Moxifloxacin IV/PO Q24H"]
    N2 --> N9
    N10["Patient in ICU<br/><br/>Condition: patient_in_icu"]
    N1 --> N10
    N11["Risk for Pseudomonas<br/><br/>Condition: risk_for_pseudomonas<br/><br/>Decision: Use HAP recommendations"]
    N10 --> N11
    N12["No risk for Pseudomonas, no severe PCN allergy<br/><br/>Condition: NOT risk_for_pseudomonas AND NOT severe_pcn_allergy<br/><br/>Decision: Ceftriaxone IV Q24H PLUS Azithromycin IV Q24H"]
    N10 --> N12
    N13["No risk for Pseudomonas, severe PCN allergy<br/><br/>Condition: NOT risk_for_pseudomonas AND severe_pcn_allergy<br/><br/>Decision: Moxifloxacin IV Q24H"]
    N10 --> N13
    N14["Cover for MRSA<br/><br/>Condition: necrotizing_pneumonia_with_cavitation_and_influenza_like_illness<br/><br/>Decision: Add Linezolid IV/PO Q12H to above regimen while awaiting culture data"]
    N1 --> N14
    N15["Patient not in ICU, no severe PCN allergy<br/><br/>Condition: NOT patient_in_icu AND NOT severe_pcn_allergy<br/><br/>Decision: Ampicillin/sulbactam IV Q6H PLUS Azithromycin IV/PO daily OR Doxycycline IV/PO Q12H OR Ceftriaxone IV Q24H PLUS Azithromycin IV/PO daily OR Doxycycline IV/PO Q12H OR Cefdinir PO Q12H PLUS Azithromycin PO daily OR Doxycycline PO Q12H"]
    N1 --> N15
    N16["Patient not in ICU, severe PCN allergy<br/><br/>Condition: NOT patient_in_icu AND severe_pcn_allergy<br/><br/>Decision: Moxifloxacin IV/PO Q24H"]
    N1 --> N16
...
```json
{
    ...
    "indicators": [
        { "name": "s_pneumoniae_pcn_susceptible", "description": "Culture confirms S. pneumoniae susceptible to penicillin" },
        { "name": "s_pneumoniae_pcn_intermediate_or_urine_antigen_positive", "description": "Culture or urine antigen confirms S. pneumoniae with intermediate penicillin susceptibility or urine antigen positive" },
        { "name": "s_pneumoniae_pcn_resistant_cephalosporin_susceptible", "description": "Culture confirms S. pneumoniae resistant to penicillin but susceptible to cephalosporins" },
        { "name": "h_influenzae_ampicillin_susceptible", "description": "Culture confirms H. influenzae non-beta-lactamase producing (ampicillin susceptible)" },
        { "name": "h_influenzae_ampicillin_resistant", "description": "Culture confirms H. influenzae beta-lactamase producing (ampicillin resistant)" },
        { "name": "l_pneumophila", "description": "Legionella pneumophila detected via urine antigen or culture" },
        { "name": "culture_and_urine_antigen_negative", "description": "Cultures and urine antigen are negative for common CAP pathogens" },
        { "name": "blood_culture_result_available", "description": "Blood culture results available before starting treatment" },
        { "name": "urine_antigen_result_available", "description": "Urine antigen results available before starting treatment" },
        { "name": "patient_in_icu", "description": "Patient requires ICU-level care" },
        { "name": "risk_for_pseudomonas", "description": "Presence of risk factors for Pseudomonas infection" },
        { "name": "severe_pcn_allergy", "description": "Severe allergy to penicillin" },
        { "name": "necrotizing_pneumonia_with_cavitation_and_influenza_like_illness", "description": "Necrotizing pneumonia with cavitation and preceding/concomitant influenza-like illness" }
    ],
    "decision_tree": {
        ...
        "branches": [
            {
                ...
                "name": "Pathogen-specific therapy based on available results",
                "branches": [
                    {
                        "condition": "s_pneumoniae_pcn_susceptible",
                        "name": "S. pneumoniae PCN susceptible",
                        "decision": "Penicillin G IV Q6H OR Amoxicillin PO Q8H; if non-severe PCN allergy: Cefdinir PO Q12H; if severe PCN allergy: Azithromycin PO daily x3 days OR Azithromycin 500 mg once then 250 mg daily x4 days OR Moxifloxacin IV/PO daily"
                    },
                    {
                        "condition": "s_pneumoniae_pcn_intermediate_or_urine_antigen_positive",
                        "name": "S. pneumoniae intermediate PCN or urine antigen positive",
                        "decision": "Penicillin G IV Q6H OR Amoxicillin 1 g PO Q8H; same allergy alternatives as above"
                    },
                    {
                        "condition": "s_pneumoniae_pcn_resistant_cephalosporin_susceptible",
                        "name": "S. pneumoniae PCN resistant, cephalosporin susceptible",
                        "decision": "Ceftriaxone IV Q24H OR Cefdinir PO Q12H; PCN allergy: Moxifloxacin IV/PO Q24H"
                    },
                    {
                        "condition": "h_influenzae_ampicillin_susceptible",
                        "name": "H. influenzae Ampicillin susceptible",
                        "decision": "Ampicillin IV Q6H OR Amoxicillin PO Q8H; PCN allergy options: Azithromycin PO x3 days OR PO taper, Cefdinir PO Q12H, Doxycycline PO Q12H if susceptible, Moxifloxacin IV/PO daily if resistant"
                    },
                    {
                        "condition": "h_influenzae_ampicillin_resistant",
                        "name": "H. influenzae Ampicillin resistant",
                        "decision": "Ampicillin/sulbactam IV Q6H OR Amoxicillin/clavulanate PO Q12H; PCN allergy options same as above"
                    },
                    {
                        "condition": "l_pneumophila",
                        "name": "Legionella pneumophila",
                        "decision": "Azithromycin IV/PO Q24H OR Moxifloxacin IV/PO Q24H; PCN allergy: Azithromycin IV/PO Q24H x 7-10 days OR Moxifloxacin IV/PO Q24H x 10-14 days"
                    },
                    {
                        "condition": "culture_and_urine_antigen_negative",
                        "name": "Culture and urine antigen negative",
                        "decision": "Cefdinir PO BID OR Amoxicillin/clavulanate XR PO Q12H; PCN allergy: Moxifloxacin IV/PO Q24H"
                    }
                ]
            },
            {
                ...
                "branches": [
                    ...
                    },
                    {
                        ...
                        "name": "No risk for Pseudomonas, no severe PCN allergy",
                        "decision": "Ceftriaxone IV Q24H PLUS Azithromycin IV Q24H"
                    },
                    {
                        "condition": "NOT risk_for_pseudomonas AND severe_pcn_allergy",
                        "name": "No risk for Pseudomonas, severe PCN allergy",
                        "decision": "Moxifloxacin IV Q24H"
                    }
                ]
            },
            {
                ...
                "name": "Cover for MRSA",
                "decision": "Add Linezolid IV/PO Q12H to above regimen while awaiting culture data"
            },
            {
                "condition": "NOT patient_in_icu AND NOT severe_pcn_allergy",
                "name": "Patient not in ICU, no severe PCN allergy",
                "decision": "Ampicillin/sulbactam IV Q6H PLUS Azithromycin IV/PO daily OR Doxycycline IV/PO Q12H OR Ceftriaxone IV Q24H PLUS Azithromycin IV/PO daily OR Doxycycline IV/PO Q12H OR Cefdinir PO Q12H PLUS Azithromycin PO daily OR Doxycycline PO Q12H"
            },
            {
                "condition": "NOT patient_in_icu AND severe_pcn_allergy",
                "name": "Patient not in ICU, severe PCN allergy",
                "decision": "Moxifloxacin IV/PO Q24H"
            }
        ]
    }
}
