...
flowchart TD
    ...
    N1 --> N2
    N3["Patient in ICU<br/><br/>Condition: icu_admission"]
    N2 --> N3
    N4["ICU, No Pseudomonas Risk, No Severe PCN Allergy<br/><br/>Condition: NOT risk_for_pseudomonas AND NOT severe_pcn_allergy<br/><br/>Decision: Ceftriaxone plus Azithromycin"]
    N3 --> N4
    N5["ICU, No Pseudomonas Risk, Severe PCN Allergy<br/><br/>Condition: NOT risk_for_pseudomonas AND severe_pcn_allergy<br/><br/>Decision: Moxifloxacin"]
    N3 --> N5
    N6["ICU, Pseudomonas Risk<br/><br/>Condition: risk_for_pseudomonas<br/><br/>Decision: Follow HAP recommendations"]
    N3 --> N6
    N7["Patient NOT in ICU<br/><br/>Condition: NOT icu_admission"]
    N2 --> N7
    N8["No Severe PCN Allergy<br/><br/>Condition: NOT severe_pcn_allergy<br/><br/>Decision: Ampicillin/sulbactam plus Azithromycin or Doxycycline OR Ceftriaxone plus Azithromycin or Doxycycline OR Cefdinir plus Azithromycin or Doxycycline"]
    N7 --> N8
    N9["Severe PCN Allergy<br/><br/>Condition: severe_pcn_allergy<br/><br/>Decision: Moxifloxacin"]
    N7 --> N9
    N10["Consider MRSA Coverage<br/><br/>Condition: necrotizing_pneumonia_with_cavitation AND preceding_influenza_like_illness<br/><br/>Decision: Add Linezolid to regimen"]
    N2 --> N10
    N11["S. pneumoniae PCN susceptible<br/><br/>Condition: culture_positive_s_pneumoniae_pcn_susceptible<br/><br/>Decision: Penicillin G OR Amoxicillin; if PCN allergy: Cefdinir (non-severe) OR Azithromycin OR Moxifloxacin"]
    N2 --> N11
    N12["S. pneumoniae PCN intermediate or urine antigen positive<br/><br/>Condition: culture_positive_s_pneumoniae_pcn_intermediate OR positive_urine_antigen_s_pneumoniae<br/><br/>Decision: Penicillin G OR Amoxicillin; PCN allergy as above"]
    N2 --> N12
    N13["S. pneumoniae PCN resistant, cephalosporin susceptible<br/><br/>Condition: culture_positive_s_pneumoniae_pcn_resistant<br/><br/>Decision: Ceftriaxone OR Cefdinir; if PCN allergy: Moxifloxacin"]
    N2 --> N13
    N14["H. influenzae non-beta-lactamase producing<br/><br/>Condition: culture_positive_h_influenzae_ampicillin_susceptible<br/><br/>Decision: Ampicillin OR Amoxicillin; if PCN allergy: Azithromycin OR Cefdinir OR Doxycycline OR Moxifloxacin"]
    N2 --> N14
    N15["H. influenzae beta-lactamase producing<br/><br/>Condition: culture_positive_h_influenzae_ampicillin_resistant<br/><br/>Decision: Ampicillin/sulbactam OR Amoxicillin/clavulanate; if PCN allergy: Azithromycin OR Cefdinir OR Doxycycline OR Moxifloxacin"]
    N2 --> N15
    N16["Legionella pneumophila<br/><br/>Condition: positive_urine_antigen_legionella<br/><br/>Decision: Azithromycin OR Moxifloxacin"]
    N2 --> N16
    N17["Culture and urine antigen negative<br/><br/>Condition: culture_and_antigen_negative<br/><br/>Decision: Cefdinir OR Amoxicillin/clavulanate; if PCN allergy: Moxifloxacin"]
    N2 --> N17
...
```json
{
    ...
    "indicators": [
        { "name": "cough", "description": "Patient presents with cough" },
        { "name": "shortness_of_breath", "description": "Patient presents with shortness of breath" },
        { "name": "pleuritic_chest_pain", "description": "Patient presents with pleuritic chest pain" },
        { "name": "oxygen_requirement", "description": "Patient requires supplemental oxygen" },
        { "name": "radiographic_infiltrates", "description": "Radiographic evidence of pulmonary infiltrates" },
        { "name": "icu_admission", "description": "Patient is admitted to ICU" },
        { "name": "risk_for_pseudomonas", "description": "Patient has risk factors for Pseudomonas infection" },
        { "name": "severe_pcn_allergy", "description": "Patient has a severe penicillin allergy" },
        { "name": "necrotizing_pneumonia_with_cavitation", "description": "Presence of necrotizing pneumonia with cavitation" },
        { "name": "preceding_influenza_like_illness", "description": "Influenza-like illness preceding or concomitant with pneumonia" },
        { "name": "positive_urine_antigen_s_pneumoniae", "description": "Urine antigen positive for S. pneumoniae" },
        { "name": "positive_urine_antigen_legionella", "description": "Urine antigen positive for Legionella pneumophila" },
        { "name": "culture_positive_s_pneumoniae_pcn_susceptible", "description": "Culture positive for S. pneumoniae, penicillin susceptible" },
        { "name": "culture_positive_s_pneumoniae_pcn_intermediate", "description": "Culture positive for S. pneumoniae, penicillin intermediate" },
        { "name": "culture_positive_s_pneumoniae_pcn_resistant", "description": "Culture positive for S. pneumoniae, penicillin resistant and cephalosporin susceptible" },
        { "name": "culture_positive_h_influenzae_ampicillin_susceptible", "description": "Culture positive for H. influenzae, non-beta-lactamase producing" },
        { "name": "culture_positive_h_influenzae_ampicillin_resistant", "description": "Culture positive for H. influenzae, beta-lactamase producing" },
        { "name": "culture_and_antigen_negative", "description": "Culture and urine antigen negative" }
    ],
    "decision_tree": {
        ...
        "branches": [
            {
                ...
                "branches": [
                        ...
                        "branches": [
                            {
                                ...
                                "name": "ICU, No Pseudomonas Risk, No Severe PCN Allergy",
                                "decision": "Ceftriaxone plus Azithromycin"
                            },
                            {
                                "condition": "NOT risk_for_pseudomonas AND severe_pcn_allergy",
                                "name": "ICU, No Pseudomonas Risk, Severe PCN Allergy",
                                "decision": "Moxifloxacin"
                            },
                            {
                                "condition": "risk_for_pseudomonas",
                                "name": "ICU, Pseudomonas Risk",
                                "decision": "Follow HAP recommendations"
                            }
                        ]
                    },
                    {
                        "condition": "NOT icu_admission",
                        "name": "Patient NOT in ICU",
                        "branches": [
                            {
                                "condition": "NOT severe_pcn_allergy",
                                "name": "No Severe PCN Allergy",
                                "decision": "Ampicillin/sulbactam plus Azithromycin or Doxycycline OR Ceftriaxone plus Azithromycin or Doxycycline OR Cefdinir plus Azithromycin or Doxycycline"
                            },
                            {
                    ...
                    {
                        "condition": "necrotizing_pneumonia_with_cavitation AND preceding_influenza_like_illness",
                        "name": "Consider MRSA Coverage",
                        "decision": "Add Linezolid to regimen"
                    },
                    {
                        "condition": "culture_positive_s_pneumoniae_pcn_susceptible",
                        "name": "S. pneumoniae PCN susceptible",
                        "decision": "Penicillin G OR Amoxicillin; if PCN allergy: Cefdinir (non-severe) OR Azithromycin OR Moxifloxacin"
                    },
                    {
                        "condition": "culture_positive_s_pneumoniae_pcn_intermediate OR positive_urine_antigen_s_pneumoniae",
                        "name": "S. pneumoniae PCN intermediate or urine antigen positive",
                        "decision": "Penicillin G OR Amoxicillin; PCN allergy as above"
                    },
                    {
                        "condition": "culture_positive_s_pneumoniae_pcn_resistant",
                        "name": "S. pneumoniae PCN resistant, cephalosporin susceptible",
                        "decision": "Ceftriaxone OR Cefdinir; if PCN allergy: Moxifloxacin"
                    },
                    {
                        "condition": "culture_positive_h_influenzae_ampicillin_susceptible",
                        "name": "H. influenzae non-beta-lactamase producing",
                        "decision": "Ampicillin OR Amoxicillin; if PCN allergy: Azithromycin OR Cefdinir OR Doxycycline OR Moxifloxacin"
                    },
                    {
                        "condition": "culture_positive_h_influenzae_ampicillin_resistant",
                        "name": "H. influenzae beta-lactamase producing",
                        "decision": "Ampicillin/sulbactam OR Amoxicillin/clavulanate; if PCN allergy: Azithromycin OR Cefdinir OR Doxycycline OR Moxifloxacin"
                    },
                    {
                        "condition": "positive_urine_antigen_legionella",
                        "name": "Legionella pneumophila",
                        "decision": "Azithromycin OR Moxifloxacin"
                    },
                    {
                        "condition": "culture_and_antigen_negative",
                        "name": "Culture and urine antigen negative",
                        "decision": "Cefdinir OR Amoxicillin/clavulanate; if PCN allergy: Moxifloxacin"
                    }
                ]
            }
        ]
