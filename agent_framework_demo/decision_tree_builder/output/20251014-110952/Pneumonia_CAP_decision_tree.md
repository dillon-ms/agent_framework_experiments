...
flowchart TD
    ...
    N2["Confirmed CAP Diagnosis<br/><br/>Condition: symptoms_cap AND oxygen_requirement AND radiographic_infiltrates"]
    N1 --> N2
    N3["ICU Patient<br/><br/>Condition: icu_admission"]
    N2 --> N3
    N4["Pseudomonas Risk<br/><br/>Condition: risk_for_pseudomonas<br/><br/>Decision: Use Hospital-Acquired Pneumonia (HAP®) recommendations"]
    N3 --> N4
    N5["No Pseudomonas Risk & Severe Penicillin Allergy<br/><br/>Condition: NOT risk_for_pseudomonas AND severe_pcn_allergy<br/><br/>Decision: Moxifloxacin 400 mg IV Q24H"]
    N3 --> N5
    N6["No Pseudomonas Risk & No Severe Penicillin Allergy<br/><br/>Condition: NOT risk_for_pseudomonas AND NOT severe_pcn_allergy<br/><br/>Decision: Ceftriaxone 1 g IV Q24H PLUS Azithromycin 500 mg IV Q24H"]
    N3 --> N6
    N7["Non-ICU Patient<br/><br/>Condition: NOT icu_admission"]
    N2 --> N7
    N8["Severe Penicillin Allergy<br/><br/>Condition: severe_pcn_allergy<br/><br/>Decision: Moxifloxacin 400 mg IV/PO Q24H"]
    N7 --> N8
    N9["No Severe Penicillin Allergy<br/><br/>Condition: NOT severe_pcn_allergy<br/><br/>Decision: Ampicillin/sulbactam 1.5 g IV Q6H PLUS (Azithromycin 500 mg IV/PO once daily OR Doxycycline 100 mg IV/PO twice daily) OR Ceftriaxone 1 g IV Q24H PLUS (Azithromycin 500 mg IV/PO once daily OR Doxycycline 100 mg IV/PO twice daily) OR Cefdinir 300 mg PO Q12H PLUS (Azithromycin 500 mg PO once daily OR Doxycycline 100 mg PO twice daily)"]
    N7 --> N9
    N10["Necrotizing Pneumonia with Influenza-like Illness<br/><br/>Condition: necrotizing_pneumonia_with_cavitation AND influenza_like_illness<br/><br/>Decision: Add Linezolid 600 mg IV/PO Q12H to regimen while awaiting culture data; consult ID"]
    N2 --> N10
    N11["S. pneumoniae PCN Susceptible<br/><br/>Condition: pcn_susceptible_s_pneumoniae<br/><br/>Decision: Penicillin G 1.5 million units IV Q6H OR Amoxicillin 500 mg PO Q8H; For non-severe allergy: Cefdinir 300 mg PO Q12H; For severe allergy: Azithromycin regimen OR Moxifloxacin if Erythromycin resistant"]
    N2 --> N11
    N12["S. pneumoniae PCN Intermediate or Urine Antigen Positive<br/><br/>Condition: pcn_intermediate_s_pneumoniae_or_antigen_positive<br/><br/>Decision: Penicillin G 1.5 million units IV Q6H OR Amoxicillin 1 g PO Q8H; same allergy adjustments as above"]
    N2 --> N12
    N13["S. pneumoniae PCN Resistant, Cephalosporin Susceptible<br/><br/>Condition: pcn_resistant_cephalosporin_susceptible_s_pneumoniae<br/><br/>Decision: Ceftriaxone 1 g IV Q24H OR Cefdinir 300 mg PO Q12H; For allergy: Moxifloxacin 400 mg IV/PO Q24H"]
    N2 --> N13
    N14["H. influenzae Ampicillin Susceptible<br/><br/>Condition: ampicillin_susceptible_h_influenzae<br/><br/>Decision: Ampicillin 1 g IV Q6H OR Amoxicillin 500 mg PO Q8H; For allergy: Azithromycin regimen OR Cefdinir 300 mg PO Q12H OR Doxycycline 100 mg PO Q12H OR Moxifloxacin if resistant"]
    N2 --> N14
    N15["H. influenzae Ampicillin Resistant (Beta-lactamase producing)<br/><br/>Condition: ampicillin_resistant_h_influenzae<br/><br/>Decision: Ampicillin/sulbactam 1.5 g Q6H OR Amoxicillin/clavulanate 875 mg PO Q12H; For allergy: Azithromycin regimen OR Cefdinir 300 mg PO Q12H OR Doxycycline 100 mg PO Q12H OR Moxifloxacin if resistant"]
    N2 --> N15
    N16["Legionella pneumophila Infection<br/><br/>Condition: l_pneumophila_infection<br/><br/>Decision: Azithromycin 500 mg IV/PO Q24H OR Moxifloxacin 400 mg IV/PO Q24H; For allergy: same agents with specified treatment duration"]
    N2 --> N16
    N17["Culture and Urine Antigen Negative<br/><br/>Condition: culture_and_antigen_negative<br/><br/>Decision: Cefdinir 300 mg PO BID OR Amoxicillin/clavulanate XR 2 g PO Q12H; For allergy: Moxifloxacin 400 mg IV/PO Q24H"]
    N2 --> N17
...
```json
{
    ...
    "indicators": [
        { "name": "symptoms_cap", "description": "Presence of cough, shortness of breath, or pleuritic chest pain" },
        { "name": "oxygen_requirement", "description": "Patient requires supplemental oxygen" },
        { "name": "radiographic_infiltrates", "description": "Evidence of infiltrates on chest imaging" },
        { "name": "icu_admission", "description": "Patient is admitted to the Intensive Care Unit" },
        { "name": "severe_pcn_allergy", "description": "History of severe penicillin allergy" },
        { "name": "risk_for_pseudomonas", "description": "Presence of any risk factors for Pseudomonas infection such as bronchiectasis, structural lung disease, prior broad-spectrum antibiotics > 7 days in past month, prolonged hospitalization > 7 days in past 3 months, recent nursing home stay, mechanical ventilation > 48 hours, or significant immunocompromise" },
        { "name": "necrotizing_pneumonia_with_cavitation", "description": "Radiologic evidence of necrotizing pneumonia with cavitation without aspiration risk factors" },
        { "name": "influenza_like_illness", "description": "Preceding or concomitant influenza-like illness" },
        { "name": "pcn_susceptible_s_pneumoniae", "description": "Lab-confirmed S. pneumoniae susceptible to penicillin" },
        { "name": "pcn_intermediate_s_pneumoniae_or_antigen_positive", "description": "Lab-confirmed S. pneumoniae with intermediate penicillin susceptibility or positive urine antigen" },
        { "name": "pcn_resistant_cephalosporin_susceptible_s_pneumoniae", "description": "Lab-confirmed S. pneumoniae resistant to penicillin but susceptible to cephalosporins" },
        { "name": "ampicillin_susceptible_h_influenzae", "description": "Lab-confirmed H. influenzae non-beta-lactamase producing and susceptible to ampicillin" },
        { "name": "ampicillin_resistant_h_influenzae", "description": "Lab-confirmed H. influenzae beta-lactamase producing and resistant to ampicillin" },
        { "name": "l_pneumophila_infection", "description": "Confirmed Legionella pneumophila infection" },
        { "name": "culture_and_antigen_negative", "description": "Negative culture and urine antigen tests" }
    ],
    "decision_tree": {
        "title": "Community-Acquired Pneumonia (CAP®) Decision Tree",
        "branches": [
            {
                "condition": "symptoms_cap AND oxygen_requirement AND radiographic_infiltrates",
                "name": "Confirmed CAP Diagnosis",
                "branches": [
                    {
                        "condition": "icu_admission",
                        "name": "ICU Patient",
                        "branches": [
                            {
                                "condition": "risk_for_pseudomonas",
                                "name": "Pseudomonas Risk",
                                "decision": "Use Hospital-Acquired Pneumonia (HAP®) recommendations"
                            },
                            {
                                "condition": "NOT risk_for_pseudomonas AND severe_pcn_allergy",
                                "name": "No Pseudomonas Risk & Severe Penicillin Allergy",
                                "decision": "Moxifloxacin 400 mg IV Q24H"
                            },
                            {
                                "condition": "NOT risk_for_pseudomonas AND NOT severe_pcn_allergy",
                                "name": "No Pseudomonas Risk & No Severe Penicillin Allergy",
                                "decision": "Ceftriaxone 1 g IV Q24H PLUS Azithromycin 500 mg IV Q24H"
                            }
                        ]
                    },
                    {
                        "condition": "NOT icu_admission",
                        "name": "Non-ICU Patient",
                        "branches": [
                            {
                                "condition": "severe_pcn_allergy",
                                "name": "Severe Penicillin Allergy",
                                "decision": "Moxifloxacin 400 mg IV/PO Q24H"
                            },
                            {
                                "condition": "NOT severe_pcn_allergy",
                                "name": "No Severe Penicillin Allergy",
                                "decision": "Ampicillin/sulbactam 1.5 g IV Q6H PLUS (Azithromycin 500 mg IV/PO once daily OR Doxycycline 100 mg IV/PO twice daily) OR Ceftriaxone 1 g IV Q24H PLUS (Azithromycin 500 mg IV/PO once daily OR Doxycycline 100 mg IV/PO twice daily) OR Cefdinir 300 mg PO Q12H PLUS (Azithromycin 500 mg PO once daily OR Doxycycline 100 mg PO twice daily)"
                            }
                        ]
                    },
                    {
                        "condition": "necrotizing_pneumonia_with_cavitation AND influenza_like_illness",
                        "name": "Necrotizing Pneumonia with Influenza-like Illness",
                        "decision": "Add Linezolid 600 mg IV/PO Q12H to regimen while awaiting culture data; consult ID"
                    },
                    {
                        "condition": "pcn_susceptible_s_pneumoniae",
                        "name": "S. pneumoniae PCN Susceptible",
                        "decision": "Penicillin G 1.5 million units IV Q6H OR Amoxicillin 500 mg PO Q8H; For non-severe allergy: Cefdinir 300 mg PO Q12H; For severe allergy: Azithromycin regimen OR Moxifloxacin if Erythromycin resistant"
                    },
                    {
                        "condition": "pcn_intermediate_s_pneumoniae_or_antigen_positive",
                        "name": "S. pneumoniae PCN Intermediate or Urine Antigen Positive",
                        "decision": "Penicillin G 1.5 million units IV Q6H OR Amoxicillin 1 g PO Q8H; same allergy adjustments as above"
                    },
                    {
                        "condition": "pcn_resistant_cephalosporin_susceptible_s_pneumoniae",
                        "name": "S. pneumoniae PCN Resistant, Cephalosporin Susceptible",
                        "decision": "Ceftriaxone 1 g IV Q24H OR Cefdinir 300 mg PO Q12H; For allergy: Moxifloxacin 400 mg IV/PO Q24H"
                    },
                    {
                        "condition": "ampicillin_susceptible_h_influenzae",
                        "name": "H. influenzae Ampicillin Susceptible",
                        "decision": "Ampicillin 1 g IV Q6H OR Amoxicillin 500 mg PO Q8H; For allergy: Azithromycin regimen OR Cefdinir 300 mg PO Q12H OR Doxycycline 100 mg PO Q12H OR Moxifloxacin if resistant"
                    },
                    {
                        "condition": "ampicillin_resistant_h_influenzae",
                        "name": "H. influenzae Ampicillin Resistant (Beta-lactamase producing)",
                        "decision": "Ampicillin/sulbactam 1.5 g Q6H OR Amoxicillin/clavulanate 875 mg PO Q12H; For allergy: Azithromycin regimen OR Cefdinir 300 mg PO Q12H OR Doxycycline 100 mg PO Q12H OR Moxifloxacin if resistant"
                    },
                    {
                        "condition": "l_pneumophila_infection",
                        "name": "Legionella pneumophila Infection",
                        "decision": "Azithromycin 500 mg IV/PO Q24H OR Moxifloxacin 400 mg IV/PO Q24H; For allergy: same agents with specified treatment duration"
                    },
                    {
                        "condition": "culture_and_antigen_negative",
                        "name": "Culture and Urine Antigen Negative",
                        "decision": "Cefdinir 300 mg PO BID OR Amoxicillin/clavulanate XR 2 g PO Q12H; For allergy: Moxifloxacin 400 mg IV/PO Q24H"
                    }
                ]
            }
        ]
