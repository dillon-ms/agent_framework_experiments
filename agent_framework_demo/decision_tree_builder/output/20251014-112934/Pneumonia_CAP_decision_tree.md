...
flowchart TD
    ...
    N2["S. pneumoniae PCN susceptible<br/><br/>Condition: blood_culture_result_available AND culture_positive_s_pneumoniae_pcn_susceptible"]
    N1 --> N2
    N3["Treat with penicillin or amoxicillin<br/><br/>Condition: NOT severe_pcn_allergy<br/><br/>Decision: Penicillin G 1.5 million units IV Q6H OR Amoxicillin 500 mg PO Q8H"]
    N2 --> N3
    N4["Treat with azithromycin or moxifloxacin<br/><br/>Condition: severe_pcn_allergy<br/><br/>Decision: Azithromycin 500 mg PO daily x 3 days OR 500 mg once then 250 mg PO daily x 4 days OR Moxifloxacin 400 mg IV/PO daily"]
    N2 --> N4
    N5["S. pneumoniae PCN intermediate or urine antigen positive<br/><br/>Condition: blood_culture_result_available AND (culture_positive_s_pneumoniae_pcn_intermediate OR urine_antigen_positive_s_pneumoniae)"]
    N1 --> N5
    N5 --> N6
    N5 --> N7
    N8["S. pneumoniae PCN resistant, cephalosporin susceptible<br/><br/>Condition: blood_culture_result_available AND culture_positive_s_pneumoniae_pcn_resistant_cephalosporin_susceptible"]
    N1 --> N8
    N8 --> N9
    N8 --> N10
    N11["H. influenzae ampicillin susceptible<br/><br/>Condition: blood_culture_result_available AND culture_positive_h_influenzae_ampicillin_susceptible"]
    N1 --> N11
    N11 --> N12
    N11 --> N13
    N14["H. influenzae ampicillin resistant<br/><br/>Condition: blood_culture_result_available AND culture_positive_h_influenzae_ampicillin_resistant"]
    N1 --> N14
    N14 --> N15
    N14 --> N16
    N17["Legionella pneumophila<br/><br/>Condition: blood_culture_result_available AND urine_antigen_positive_legionella<br/><br/>Decision: Azithromycin 500 mg IV/PO Q24H OR Moxifloxacin 400 mg IV/PO Q24H"]
    N1 --> N17
    N18["Culture and urine antigen negative<br/><br/>Condition: blood_culture_result_available AND culture_negative"]
    N1 --> N18
    N18 --> N19
    N18 --> N20
    N21["Empiric coverage for CA-MRSA<br/><br/>Condition: necrotizing_pneumonia_with_cavitation AND influenza_like_illness<br/><br/>Decision: Add Linezolid 600 mg IV/PO Q12H to above regimen"]
    N1 --> N21
    N22["ICU patient with risk for Pseudomonas<br/><br/>Condition: patient_in_ICU AND risk_for_pseudomonas<br/><br/>Decision: Use HAP recommendations"]
    N1 --> N22
    N23["ICU patient without risk for Pseudomonas<br/><br/>Condition: patient_in_ICU AND NOT risk_for_pseudomonas AND NOT severe_pcn_allergy<br/><br/>Decision: Ceftriaxone 1 g IV Q24H PLUS Azithromycin 500 mg IV Q24H"]
    N1 --> N23
    N24["ICU patient without risk for Pseudomonas, severe PCN allergy<br/><br/>Condition: patient_in_ICU AND NOT risk_for_pseudomonas AND severe_pcn_allergy<br/><br/>Decision: Moxifloxacin 400 mg IV/PO Q24H"]
    N1 --> N24
    N25["Non-ICU patient with severe PCN allergy<br/><br/>Condition: NOT patient_in_ICU AND severe_pcn_allergy<br/><br/>Decision: Moxifloxacin 400 mg IV/PO Q24H"]
    N1 --> N25
    N26["Non-ICU patient without severe PCN allergy<br/><br/>Condition: NOT patient_in_ICU AND NOT severe_pcn_allergy<br/><br/>Decision: Ampicillin/sulbactam 1.5 g IV Q6H PLUS (Azithromycin 500 mg IV/PO daily OR Doxycycline 100 mg IV/PO BID) OR Ceftriaxone 1 g IV Q24H PLUS (Azithromycin 500 mg IV/PO daily OR Doxycycline 100 mg IV/PO BID) OR Cefdinir 300 mg PO Q12H PLUS (Azithromycin 500 mg PO daily OR Doxycycline 100 mg PO BID)"]
    N1 --> N26
...
```json
{
    ...
    "indicators": [
        { "name": "blood_culture_result_available", "description": "Whether blood culture results are available at time of decision making" },
        { "name": "urine_antigen_positive_s_pneumoniae", "description": "Urine antigen test positive for Streptococcus pneumoniae" },
        { "name": "urine_antigen_positive_legionella", "description": "Urine antigen test positive for Legionella pneumophila serogroup 1" },
        { "name": "culture_positive_s_pneumoniae_pcn_susceptible", "description": "Culture result shows S. pneumoniae, penicillin susceptible" },
        { "name": "culture_positive_s_pneumoniae_pcn_intermediate", "description": "Culture result shows S. pneumoniae, penicillin intermediate" },
        { "name": "culture_positive_s_pneumoniae_pcn_resistant_cephalosporin_susceptible", "description": "Culture result shows S. pneumoniae, penicillin resistant, cephalosporin susceptible" },
        { "name": "culture_positive_h_influenzae_ampicillin_susceptible", "description": "Culture result shows H. influenzae, non-beta-lactamase producing (ampicillin susceptible)" },
        { "name": "culture_positive_h_influenzae_ampicillin_resistant", "description": "Culture result shows H. influenzae, beta-lactamase producing (ampicillin resistant)" },
        { "name": "culture_negative", "description": "Culture negative for bacterial pathogens" },
        { "name": "severe_pcn_allergy", "description": "History of severe allergic reaction to penicillin" },
        { "name": "patient_in_ICU", "description": "Patient is currently admitted to ICU" },
        { "name": "risk_for_pseudomonas", "description": "Patient has risk factors for Pseudomonas infection" },
        { "name": "necrotizing_pneumonia_with_cavitation", "description": "Patient presents with necrotizing pneumonia with cavitation" },
        { "name": "influenza_like_illness", "description": "Patient has preceding or concomitant influenza-like illness" }
    ],
    "decision_tree": {
        "title": "Community-Acquired Pneumonia (CAP®) Decision Tree",
        "branches": [
            {
                "condition": "blood_culture_result_available AND culture_positive_s_pneumoniae_pcn_susceptible",
                "name": "S. pneumoniae PCN susceptible",
                "branches": [
                    {
                        "condition": "NOT severe_pcn_allergy",
                        "name": "Treat with penicillin or amoxicillin",
                        "decision": "Penicillin G 1.5 million units IV Q6H OR Amoxicillin 500 mg PO Q8H"
                    },
                    {
                        "condition": "severe_pcn_allergy",
                        "name": "Treat with azithromycin or moxifloxacin",
                        "decision": "Azithromycin 500 mg PO daily x 3 days OR 500 mg once then 250 mg PO daily x 4 days OR Moxifloxacin 400 mg IV/PO daily"
                    }
                ]
            },
            {
                "condition": "blood_culture_result_available AND (culture_positive_s_pneumoniae_pcn_intermediate OR urine_antigen_positive_s_pneumoniae)",
            ...
            {
                "condition": "blood_culture_result_available AND culture_positive_s_pneumoniae_pcn_resistant_cephalosporin_susceptible",
            ...
            {
                "condition": "blood_culture_result_available AND culture_positive_h_influenzae_ampicillin_susceptible",
                ...
                "branches": [
                    ...
                    {
                        "condition": "severe_pcn_allergy",
                        "decision": "Azithromycin 500 mg PO daily x 3 days OR Cefdinir 300 mg PO Q12H OR Doxycycline 100 mg PO Q12H OR Moxifloxacin 400 mg IV/PO daily"
                    }
                ]
            },
            {
                "condition": "blood_culture_result_available AND culture_positive_h_influenzae_ampicillin_resistant",
                "name": "H. influenzae ampicillin resistant",
                "branches": [
                    {
                        "condition": "NOT severe_pcn_allergy",
                        "decision": "Ampicillin/sulbactam 1.5 g IV Q6H OR Amoxicillin/clavulanate 875 mg PO Q12H"
                    },
                    {
                        "condition": "severe_pcn_allergy",
                        "decision": "Azithromycin 500 mg PO daily x 3 days OR Cefdinir 300 mg PO Q12H OR Doxycycline 100 mg PO Q12H OR Moxifloxacin 400 mg IV/PO Q24H"
                    }
                ]
            },
            {
                "condition": "blood_culture_result_available AND urine_antigen_positive_legionella",
                "name": "Legionella pneumophila",
                "decision": "Azithromycin 500 mg IV/PO Q24H OR Moxifloxacin 400 mg IV/PO Q24H"
            },
            {
                "condition": "blood_culture_result_available AND culture_negative",
            ...
            },
            {
                ...
                "name": "Empiric coverage for CA-MRSA",
                "decision": "Add Linezolid 600 mg IV/PO Q12H to above regimen"
            },
            {
                "condition": "patient_in_ICU AND risk_for_pseudomonas",
                "name": "ICU patient with risk for Pseudomonas",
                "decision": "Use HAP recommendations"
            },
            {
                "condition": "patient_in_ICU AND NOT risk_for_pseudomonas AND NOT severe_pcn_allergy",
                "name": "ICU patient without risk for Pseudomonas",
                "decision": "Ceftriaxone 1 g IV Q24H PLUS Azithromycin 500 mg IV Q24H"
            },
            {
                "condition": "patient_in_ICU AND NOT risk_for_pseudomonas AND severe_pcn_allergy",
                "name": "ICU patient without risk for Pseudomonas, severe PCN allergy",
                "decision": "Moxifloxacin 400 mg IV/PO Q24H"
            },
            {
                "condition": "NOT patient_in_ICU AND severe_pcn_allergy",
                "name": "Non-ICU patient with severe PCN allergy",
                "decision": "Moxifloxacin 400 mg IV/PO Q24H"
            },
            {
                "condition": "NOT patient_in_ICU AND NOT severe_pcn_allergy",
                "name": "Non-ICU patient without severe PCN allergy",
                "decision": "Ampicillin/sulbactam 1.5 g IV Q6H PLUS (Azithromycin 500 mg IV/PO daily OR Doxycycline 100 mg IV/PO BID) OR Ceftriaxone 1 g IV Q24H PLUS (Azithromycin 500 mg IV/PO daily OR Doxycycline 100 mg IV/PO BID) OR Cefdinir 300 mg PO Q12H PLUS (Azithromycin 500 mg PO daily OR Doxycycline 100 mg PO BID)"
            }
        ]
    }
}
