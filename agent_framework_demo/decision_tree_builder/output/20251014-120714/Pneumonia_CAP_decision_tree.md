...
{
    "is_done": true,
    "decision": "Penicillin G 1.5 million units IV Q6H OR Amoxicillin 1 g PO Q8H; allergy options same as PCN susceptible branch",
    "path": [
...
flowchart TD
    ...
    N2["S. pneumoniae PCN susceptible<br/><br/>Condition: (blood_culture_result_available OR sputum_culture_result_available OR urine_culture_result_available) AND pcn_susceptible_s_pneumoniae<br/><br/>Decision: Penicillin G 1.5 million units IV Q6H OR Amoxicillin 500 mg PO Q8H; if non_severe_pcn_allergy: Cefdinir 300 mg PO Q12H; if severe_pcn_allergy: Azithromycin 500 mg PO daily x 3 days OR Azithromycin 500 mg once then 250 mg PO daily x 4 days OR Moxifloxacin 400 mg IV/PO daily (if erythromycin resistant)"]
    N1 --> N2
    N3["S. pneumoniae PCN intermediate or urine antigen positive<br/><br/>Condition: (blood_culture_result_available OR sputum_culture_result_available OR urine_culture_result_available) AND (pcn_intermediate_s_pneumoniae OR urine_antigen_positive_s_pneumoniae)<br/><br/>Decision: Penicillin G 1.5 million units IV Q6H OR Amoxicillin 1 g PO Q8H; allergy options same as PCN susceptible branch"]
    N1 --> N3
    N4["S. pneumoniae PCN resistant, cephalosporin susceptible<br/><br/>Condition: (blood_culture_result_available OR sputum_culture_result_available OR urine_culture_result_available) AND pcn_resistant_cephalosporin_susceptible_s_pneumoniae<br/><br/>Decision: Ceftriaxone 1 g IV Q24H OR Cefdinir 300 mg PO Q12H; if severe_pcn_allergy: Moxifloxacin 400 mg IV/PO Q24H"]
    N1 --> N4
    N5["H. influenzae ampicillin susceptible<br/><br/>Condition: (blood_culture_result_available OR sputum_culture_result_available OR urine_culture_result_available) AND ampicillin_susceptible_h_influenzae<br/><br/>Decision: Ampicillin 1 g IV Q6H OR Amoxicillin 500 mg PO Q8H; if pcn allergy: Azithromycin 500 mg daily x 3 days OR Azithromycin 500 mg once then 250 mg PO daily x 4 days OR Cefdinir 300 mg PO Q12H OR Doxycycline 100 mg PO Q12H (if tetracycline susceptible) OR Moxifloxacin 400 mg IV/PO daily (if resistant to other options)"]
    N1 --> N5
    N6["H. influenzae ampicillin resistant<br/><br/>Condition: (blood_culture_result_available OR sputum_culture_result_available OR urine_culture_result_available) AND ampicillin_resistant_h_influenzae<br/><br/>Decision: Ampicillin/sulbactam 1.5 g Q6H OR Amoxicillin/clavulanate 875 mg PO Q12H; if pcn allergy: Azithromycin OR Cefdinir OR Doxycycline (tetracycline susceptible) OR Moxifloxacin as above"]
    N1 --> N6
    N7["L. pneumophila identified<br/><br/>Condition: (blood_culture_result_available OR sputum_culture_result_available OR urine_culture_result_available) AND l_pneumophila_identified<br/><br/>Decision: Azithromycin 500 mg IV/PO Q24H OR Moxifloxacin 400 mg IV/PO Q24H; if pcn allergy: same agents with Azithromycin for 7–10 days OR Moxifloxacin 10–14 days"]
    N1 --> N7
    N8["Culture and urine antigen negative<br/><br/>Condition: culture_negative_and_urine_antigen_negative<br/><br/>Decision: Cefdinir 300 mg PO BID OR Amoxicillin/clavulanate XR 2 g PO Q12H; if severe_pcn_allergy: Moxifloxacin 400 mg IV/PO Q24H"]
    N1 --> N8
    N9["Necrotizing pneumonia with cavitation and influenza-like illness<br/><br/>Condition: necrotizing_pneumonia_with_cavitation_and_influenza_like_illness<br/><br/>Decision: Add Linezolid 600 mg IV/PO Q12H to above regimen; consult ID"]
    N1 --> N9
    N10["ICU patient without pseudomonas risk and no severe PCN allergy<br/><br/>Condition: icu_patient AND NOT risk_for_pseudomonas AND NOT severe_pcn_allergy<br/><br/>Decision: Ceftriaxone 1 g IV Q24H PLUS Azithromycin 500 mg IV Q24H"]
    N1 --> N10
    N11["ICU patient without pseudomonas risk and severe PCN allergy<br/><br/>Condition: icu_patient AND NOT risk_for_pseudomonas AND severe_pcn_allergy<br/><br/>Decision: Moxifloxacin 400 mg IV Q24H"]
    N1 --> N11
    N12["ICU patient with pseudomonas risk<br/><br/>Condition: icu_patient AND risk_for_pseudomonas<br/><br/>Decision: Use HAP recommendations"]
    N1 --> N12
    N13["Non-ICU patient, no severe pcn allergy<br/><br/>Condition: NOT icu_patient AND NOT severe_pcn_allergy<br/><br/>Decision: Ampicillin/sulbactam 1.5 g IV Q6H PLUS Azithromycin 500 mg IV/PO QD OR Doxycycline 100 mg IV/PO BID OR Ceftriaxone 1 g IV Q24H PLUS Azithromycin OR Doxycycline OR Cefdinir 300 mg PO Q12H PLUS Azithromycin OR Doxycycline"]
    N1 --> N13
    N14["Non-ICU patient, severe pcn allergy<br/><br/>Condition: NOT icu_patient AND severe_pcn_allergy<br/><br/>Decision: Moxifloxacin 400 mg IV/PO Q24H"]
    N1 --> N14
...
```json
{
    ...
    "indicators": [
        { "name": "pcn_susceptible_s_pneumoniae", "description": "Blood or sputum culture confirms S. pneumoniae susceptible to penicillin" },
        { "name": "pcn_intermediate_s_pneumoniae", "description": "Blood or sputum culture confirms S. pneumoniae with intermediate penicillin susceptibility" },
        { "name": "pcn_resistant_cephalosporin_susceptible_s_pneumoniae", "description": "Blood or sputum culture confirms S. pneumoniae resistant to penicillin but susceptible to cephalosporin" },
        { "name": "urine_antigen_positive_s_pneumoniae", "description": "Positive S. pneumoniae urine antigen" },
        { "name": "ampicillin_susceptible_h_influenzae", "description": "Blood or sputum culture confirms non-beta-lactamase producing H. influenzae susceptible to ampicillin" },
        { "name": "ampicillin_resistant_h_influenzae", "description": "Blood or sputum culture confirms beta-lactamase producing H. influenzae resistant to ampicillin" },
        { "name": "l_pneumophila_identified", "description": "Positive Legionella urine antigen or culture identifying L. pneumophila" },
        { "name": "culture_negative_and_urine_antigen_negative", "description": "All cultures and urine antigen tests are negative" },
        { "name": "severe_pcn_allergy", "description": "History of severe allergic reaction to penicillin" },
        { "name": "non_severe_pcn_allergy", "description": "History of non-severe allergic reaction to penicillin" },
        { "name": "icu_patient", "description": "Patient is currently in the intensive care unit" },
        { "name": "risk_for_pseudomonas", "description": "Patient has risk factors for Pseudomonas infection" },
        { "name": "necrotizing_pneumonia_with_cavitation_and_influenza_like_illness", "description": "Radiographic evidence of necrotizing pneumonia with cavitation and preceding or concomitant influenza-like illness" },
        { "name": "blood_culture_result_available", "description": "Blood culture results are available" },
        { "name": "sputum_culture_result_available", "description": "Sputum culture results are available" },
        { "name": "urine_culture_result_available", "description": "Urine culture results are available" }
    ],
    "decision_tree": {
        "title": "Community-Acquired Pneumonia (CAP®) Decision Tree",
        "branches": [
            {
                "condition": "(blood_culture_result_available OR sputum_culture_result_available OR urine_culture_result_available) AND pcn_susceptible_s_pneumoniae",
                "name": "S. pneumoniae PCN susceptible",
                "decision": "Penicillin G 1.5 million units IV Q6H OR Amoxicillin 500 mg PO Q8H; if non_severe_pcn_allergy: Cefdinir 300 mg PO Q12H; if severe_pcn_allergy: Azithromycin 500 mg PO daily x 3 days OR Azithromycin 500 mg once then 250 mg PO daily x 4 days OR Moxifloxacin 400 mg IV/PO daily (if erythromycin resistant)"
            },
            {
                "condition": "(blood_culture_result_available OR sputum_culture_result_available OR urine_culture_result_available) AND (pcn_intermediate_s_pneumoniae OR urine_antigen_positive_s_pneumoniae)",
                "name": "S. pneumoniae PCN intermediate or urine antigen positive",
                "decision": "Penicillin G 1.5 million units IV Q6H OR Amoxicillin 1 g PO Q8H; allergy options same as PCN susceptible branch"
            },
            {
                "condition": "(blood_culture_result_available OR sputum_culture_result_available OR urine_culture_result_available) AND pcn_resistant_cephalosporin_susceptible_s_pneumoniae",
                "name": "S. pneumoniae PCN resistant, cephalosporin susceptible",
                "decision": "Ceftriaxone 1 g IV Q24H OR Cefdinir 300 mg PO Q12H; if severe_pcn_allergy: Moxifloxacin 400 mg IV/PO Q24H"
            },
            {
                "condition": "(blood_culture_result_available OR sputum_culture_result_available OR urine_culture_result_available) AND ampicillin_susceptible_h_influenzae",
                "name": "H. influenzae ampicillin susceptible",
                "decision": "Ampicillin 1 g IV Q6H OR Amoxicillin 500 mg PO Q8H; if pcn allergy: Azithromycin 500 mg daily x 3 days OR Azithromycin 500 mg once then 250 mg PO daily x 4 days OR Cefdinir 300 mg PO Q12H OR Doxycycline 100 mg PO Q12H (if tetracycline susceptible) OR Moxifloxacin 400 mg IV/PO daily (if resistant to other options)"
            },
            {
                "condition": "(blood_culture_result_available OR sputum_culture_result_available OR urine_culture_result_available) AND ampicillin_resistant_h_influenzae",
                "name": "H. influenzae ampicillin resistant",
                "decision": "Ampicillin/sulbactam 1.5 g Q6H OR Amoxicillin/clavulanate 875 mg PO Q12H; if pcn allergy: Azithromycin OR Cefdinir OR Doxycycline (tetracycline susceptible) OR Moxifloxacin as above"
            },
            {
                "condition": "(blood_culture_result_available OR sputum_culture_result_available OR urine_culture_result_available) AND l_pneumophila_identified",
                "name": "L. pneumophila identified",
                "decision": "Azithromycin 500 mg IV/PO Q24H OR Moxifloxacin 400 mg IV/PO Q24H; if pcn allergy: same agents with Azithromycin for 7–10 days OR Moxifloxacin 10–14 days"
            },
            {
                "condition": "culture_negative_and_urine_antigen_negative",
                "name": "Culture and urine antigen negative",
                "decision": "Cefdinir 300 mg PO BID OR Amoxicillin/clavulanate XR 2 g PO Q12H; if severe_pcn_allergy: Moxifloxacin 400 mg IV/PO Q24H"
            },
            {
                ...
                "decision": "Add Linezolid 600 mg IV/PO Q12H to above regimen; consult ID"
            },
            {
                "condition": "icu_patient AND NOT risk_for_pseudomonas AND NOT severe_pcn_allergy",
                "name": "ICU patient without pseudomonas risk and no severe PCN allergy",
                "decision": "Ceftriaxone 1 g IV Q24H PLUS Azithromycin 500 mg IV Q24H"
            },
            {
                "condition": "icu_patient AND NOT risk_for_pseudomonas AND severe_pcn_allergy",
                "name": "ICU patient without pseudomonas risk and severe PCN allergy",
                "decision": "Moxifloxacin 400 mg IV Q24H"
            },
            {
                "condition": "icu_patient AND risk_for_pseudomonas",
                "name": "ICU patient with pseudomonas risk",
                "decision": "Use HAP recommendations"
            },
            {
                "condition": "NOT icu_patient AND NOT severe_pcn_allergy",
                "name": "Non-ICU patient, no severe pcn allergy",
                "decision": "Ampicillin/sulbactam 1.5 g IV Q6H PLUS Azithromycin 500 mg IV/PO QD OR Doxycycline 100 mg IV/PO BID OR Ceftriaxone 1 g IV Q24H PLUS Azithromycin OR Doxycycline OR Cefdinir 300 mg PO Q12H PLUS Azithromycin OR Doxycycline"
            },
            {
                "condition": "NOT icu_patient AND severe_pcn_allergy",
                "name": "Non-ICU patient, severe pcn allergy",
