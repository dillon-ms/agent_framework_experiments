...
flowchart TD
    ...
    N2 --> N3
    N4["ICU patient with Pseudomonas risk<br/><br/>Condition: risk_for_pseudomonas<br/><br/>Decision: Use HAP recommendations"]
    N3 --> N4
    N5["ICU patient severe PCN allergy<br/><br/>Condition: NOT risk_for_pseudomonas AND severe_pcn_allergy<br/><br/>Decision: Moxifloxacin 400 mg IV Q24H"]
    N3 --> N5
    N6["ICU patient no severe PCN allergy<br/><br/>Condition: NOT risk_for_pseudomonas AND NOT severe_pcn_allergy<br/><br/>Decision: Ceftriaxone 1 g IV Q24H PLUS Azithromycin 500 mg IV Q24H"]
    N3 --> N6
    N7["Non-ICU patient<br/><br/>Condition: NOT patient_in_ICU"]
    N2 --> N7
    N8["Non-ICU severe PCN allergy<br/><br/>Condition: severe_pcn_allergy<br/><br/>Decision: Moxifloxacin 400 mg IV/PO Q24H"]
    N7 --> N8
    N9["Non-ICU no severe PCN allergy<br/><br/>Condition: NOT severe_pcn_allergy<br/><br/>Decision: Ampicillin/sulbactam 1.5 g IV Q6H PLUS (Azithromycin 500 mg IV/PO QD OR Doxycycline 100 mg IV/PO BID) OR Ceftriaxone 1 g IV Q24H PLUS (Azithromycin 500 mg IV/PO QD OR Doxycycline 100 mg IV/PO BID) OR Cefdinir 300 mg PO Q12H PLUS (Azithromycin 500 mg PO QD OR Doxycycline 100 mg PO BID)"]
    N7 --> N9
    N10["Cover for CA-MRSA<br/><br/>Condition: necrotizing_pneumonia_with_cavitation AND preceding_or_concomitant_influenza_like_illness<br/><br/>Decision: Add Linezolid 600 mg IV/PO Q12H to regimen while awaiting culture data"]
    N2 --> N10
    N11["Pathogen-specific treatment<br/><br/>Condition: blood_culture_result_available OR sputum_culture_result_available"]
    N2 --> N11
    N12["S. pneumoniae PCN susceptible<br/><br/>Condition: pcn_susceptible_s_pneumoniae<br/><br/>Decision: Penicillin G 1.5 million units IV Q6H OR Amoxicillin 500 mg PO Q8H (PCN allergy: Non-severe - Cefdinir 300 mg PO Q12H; Severe - Azithromycin or Moxifloxacin)"]
    N11 --> N12
    N13["S. pneumoniae PCN intermediate or urine antigen positive<br/><br/>Condition: pcn_intermediate_s_pneumoniae OR urine_antigen_positive_s_pneumoniae<br/><br/>Decision: Penicillin G 1.5 million units IV Q6H OR Amoxicillin 1 g PO Q8H (PCN allergy: same options as PCN susceptible)"]
    N11 --> N13
    N14["S. pneumoniae PCN resistant, cephalosporin susceptible<br/><br/>Condition: pcn_resistant_cephalosporin_susceptible_s_pneumoniae<br/><br/>Decision: Ceftriaxone 1 g IV Q24H OR Cefdinir 300 mg PO Q12H (PCN allergy: Moxifloxacin 400 mg IV/PO Q24H)"]
    N11 --> N14
    N15["H. influenzae Ampicillin susceptible<br/><br/>Condition: ampicillin_susceptible_h_influenzae<br/><br/>Decision: Ampicillin 1 g IV Q6H OR Amoxicillin 500 mg PO Q8H (PCN allergy: Azithromycin OR Cefdinir OR Doxycycline OR Moxifloxacin)"]
    N11 --> N15
    N16["H. influenzae Ampicillin resistant<br/><br/>Condition: ampicillin_resistant_h_influenzae<br/><br/>Decision: Ampicillin/sulbactam 1.5 g Q6H OR Amoxicillin/clavulanate 875 mg PO Q12H (PCN allergy: Azithromycin OR Cefdinir OR Doxycycline OR Moxifloxacin)"]
    N11 --> N16
    N17["Legionella pneumophila<br/><br/>Condition: l_pneumophila<br/><br/>Decision: Azithromycin 500 mg IV/PO Q24H OR Moxifloxacin 400 mg IV/PO Q24H (PCN allergy same options)"]
    N11 --> N17
    N18["Culture and urine antigen negative<br/><br/>Condition: culture_and_urine_antigen_negative<br/><br/>Decision: Cefdinir 300 mg PO BID OR Amoxicillin/clavulanate XR 2 g PO Q12H (PCN allergy: Moxifloxacin 400 mg IV/PO Q24H)"]
    N2 --> N18
...
```json
{
    ...
    "indicators": [
        { "name": "cough", "description": "Presence of cough" },
        { "name": "shortness_of_breath", "description": "Patient experiencing difficulty breathing" },
        { "name": "pleuritic_chest_pain", "description": "Chest pain worsened by breathing or coughing" },
        { "name": "oxygen_requirement", "description": "Patient requires supplemental oxygen" },
        { "name": "radiographic_infiltrates", "description": "Chest X-ray or CT showing infiltrates" },
        { "name": "patient_in_ICU", "description": "Patient is admitted to the Intensive Care Unit" },
        ...
        { "name": "necrotizing_pneumonia_with_cavitation", "description": "Evidence of necrotizing pneumonia with cavitation" },
        { "name": "preceding_or_concomitant_influenza_like_illness", "description": "Influenza-like illness before or during pneumonia presentation" },
        { "name": "blood_culture_result_available", "description": "Blood culture result is available" },
        { "name": "sputum_culture_result_available", "description": "Sputum culture result is available" },
        { "name": "urine_antigen_positive_s_pneumoniae", "description": "Urine antigen test positive for Streptococcus pneumoniae" },
        { "name": "pcn_susceptible_s_pneumoniae", "description": "Culture confirms S. pneumoniae susceptible to penicillin" },
        { "name": "pcn_intermediate_s_pneumoniae", "description": "Culture confirms S. pneumoniae intermediate resistance to penicillin" },
        { "name": "pcn_resistant_cephalosporin_susceptible_s_pneumoniae", "description": "Culture confirms S. pneumoniae resistant to penicillin but susceptible to cephalosporins" },
        { "name": "ampicillin_susceptible_h_influenzae", "description": "Culture confirms H. influenzae non-beta-lactamase producing and susceptible to ampicillin" },
        { "name": "ampicillin_resistant_h_influenzae", "description": "Culture confirms H. influenzae beta-lactamase producing and resistant to ampicillin" },
        { "name": "l_pneumophila", "description": "Culture or urine antigen confirms Legionella pneumophila" },
        { "name": "culture_and_urine_antigen_negative", "description": "Culture and urine antigen for major pathogens are negative" }
    ],
    "decision_tree": {
        "title": "Community-Acquired Pneumonia (CAP®) Decision Tree",
        "branches": [
            {
                "condition": "(cough OR shortness_of_breath OR pleuritic_chest_pain) AND oxygen_requirement AND radiographic_infiltrates",
                        ...
                        "branches": [
                            {
                                ...
                                "name": "Non-ICU severe PCN allergy",
                                "decision": "Moxifloxacin 400 mg IV/PO Q24H"
                            },
                            {
                                "condition": "NOT severe_pcn_allergy",
                                "name": "Non-ICU no severe PCN allergy",
                                "decision": "Ampicillin/sulbactam 1.5 g IV Q6H PLUS (Azithromycin 500 mg IV/PO QD OR Doxycycline 100 mg IV/PO BID) OR Ceftriaxone 1 g IV Q24H PLUS (Azithromycin 500 mg IV/PO QD OR Doxycycline 100 mg IV/PO BID) OR Cefdinir 300 mg PO Q12H PLUS (Azithromycin 500 mg PO QD OR Doxycycline 100 mg PO BID)"
                            }
                        ]
                    },
                    {
                        "condition": "necrotizing_pneumonia_with_cavitation AND preceding_or_concomitant_influenza_like_illness",
                        "name": "Cover for CA-MRSA",
                        "decision": "Add Linezolid 600 mg IV/PO Q12H to regimen while awaiting culture data"
                    },
                    {
                        "condition": "blood_culture_result_available OR sputum_culture_result_available",
                        "name": "Pathogen-specific treatment",
                        "branches": [
                            {
                                "condition": "pcn_susceptible_s_pneumoniae",
                                "name": "S. pneumoniae PCN susceptible",
                                "decision": "Penicillin G 1.5 million units IV Q6H OR Amoxicillin 500 mg PO Q8H (PCN allergy: Non-severe - Cefdinir 300 mg PO Q12H; Severe - Azithromycin or Moxifloxacin)"
                            },
                            {
                                "condition": "pcn_intermediate_s_pneumoniae OR urine_antigen_positive_s_pneumoniae",
                                "name": "S. pneumoniae PCN intermediate or urine antigen positive",
                                "decision": "Penicillin G 1.5 million units IV Q6H OR Amoxicillin 1 g PO Q8H (PCN allergy: same options as PCN susceptible)"
                            },
                            {
                                "condition": "pcn_resistant_cephalosporin_susceptible_s_pneumoniae",
                                "name": "S. pneumoniae PCN resistant, cephalosporin susceptible",
                                "decision": "Ceftriaxone 1 g IV Q24H OR Cefdinir 300 mg PO Q12H (PCN allergy: Moxifloxacin 400 mg IV/PO Q24H)"
                            },
                            {
                                "condition": "ampicillin_susceptible_h_influenzae",
                                "name": "H. influenzae Ampicillin susceptible",
                                "decision": "Ampicillin 1 g IV Q6H OR Amoxicillin 500 mg PO Q8H (PCN allergy: Azithromycin OR Cefdinir OR Doxycycline OR Moxifloxacin)"
                            },
                            {
                                "condition": "ampicillin_resistant_h_influenzae",
                                "name": "H. influenzae Ampicillin resistant",
                                "decision": "Ampicillin/sulbactam 1.5 g Q6H OR Amoxicillin/clavulanate 875 mg PO Q12H (PCN allergy: Azithromycin OR Cefdinir OR Doxycycline OR Moxifloxacin)"
                            },
                            {
                                "condition": "l_pneumophila",
                                "name": "Legionella pneumophila",
                                "decision": "Azithromycin 500 mg IV/PO Q24H OR Moxifloxacin 400 mg IV/PO Q24H (PCN allergy same options)"
                            }
                        ]
                    },
                    {
                        "condition": "culture_and_urine_antigen_negative",
                        "name": "Culture and urine antigen negative",
                        "decision": "Cefdinir 300 mg PO BID OR Amoxicillin/clavulanate XR 2 g PO Q12H (PCN allergy: Moxifloxacin 400 mg IV/PO Q24H)"
                    }
                ]
            }
        ]
